...
# Bot Token=
TOKEN = "1234" #The token of your bot Get via https://discord.com/developers and do the steps as listed
...
async def about(interaction: discord.Interaction):
    ...
    embed.add_field(name="Version", value="3.0.0", inline=True)      #JUST THE VERSION
